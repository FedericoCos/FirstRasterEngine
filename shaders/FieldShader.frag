...
void main() {
    ...
    total_light += diffuse_intensity * light_color + specular_contribution * specular_light;
    ...
    for (i = 0; i < 2; i++) {
        ...
        total_light += (diffuse_light + specular_contribution * specular_light) * fade_out;
    }
    ...
    for(int i = 0; i < 2; i++) {
        ...
        vec3 specular_light = getSpecular(light_dir, light_color, view_direction, normal) * smoothEdge;
    ...
    vec4 texColor = texture(texSampler, fragTexCoord * 750);
